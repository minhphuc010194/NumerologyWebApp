...
export function PyraMascot({ state = 'idle', size = 150 }: PyraMascotProps) {
  ...
  const primaryColor = useColorModeValue('#DD6B20', '#C05621');
    ...
    >
      ...
      >
        ...
        >
          ...
          <polygon points="50,15 50,85 10,85" fill="url(#pyraGradLeft)" />
          {/* 3D Base Pyramid - Right Face (darker for shadow) */}
          <polygon points="50,15 90,85 50,85" fill="url(#pyraGradRight)" />
          ...
          <motion.path
            d={
              state === 'speaking' || state === 'playful'
                ? 'M 45 78 Q 50 85 55 78 Z'
                : state === 'thinking'
                  ? 'M 48 78 Q 50 78 52 78'
                  : 'M 46 76 Q 50 80 54 76'
            }
            fill={
              state === 'speaking' || state === 'playful' ? '#FC8181' : 'none'
            }
            stroke="#2D3748"
            strokeWidth="2"
            strokeLinecap="round"
