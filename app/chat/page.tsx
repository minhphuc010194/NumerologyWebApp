...
export default function Chat() {
  ...
  const { handleInputChange, input, handleSubmit, isLoading } = useChat({
    api: "/api/chat",
    ...
    <Box>
      ...
      >
        ...
        >
          {data.map((message, index) => (
            <Box
              ...
              justifyContent={message.role === "user" ? "right" : "normal"}
            >
        ...
        <Box
          ...
          color="red.300"
        >
          Currently there is not enough operating budget for AI, sorry for the
          inconvenience
        </Box>
        <HStack>
          <InputGroup size="md">
